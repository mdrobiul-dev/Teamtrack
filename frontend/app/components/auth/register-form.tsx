...
export function RegisterForm() {
  ...
  const getStrengthLabel = () => {
    if (strengthScore === 0) return { text: 'Very Weak', color: 'bg-red-500', width: '0%' };
    if (strengthScore === 1) return { text: 'Weak', color: 'bg-red-500', width: '25%' };
    if (strengthScore === 2) return { text: 'Fair', color: 'bg-orange-500', width: '50%' };
    if (strengthScore === 3) return { text: 'Good', color: 'bg-yellow-500', width: '75%' };
        ...
        <CardContent className="space-y-5 px-8">
              ...
              <div className="mt-4 space-y-3">
                ...
                <div className="grid grid-cols-2 gap-x-4 gap-y-2 text-xs">
                  <div className="flex items-center gap-2">
                    ...
                    <span className={hasMinLength ? 'text-green-400' : 'text-gray-600'}>
                      6+ characters
                    </span>
                  </div>
                  <div className="flex items-center gap-2">
                    ...
                    <span className={hasUpperCase ? 'text-green-400' : 'text-gray-600'}>
                      Uppercase
                    </span>
                  </div>
                  <div className="flex items-center gap-2">
                    ...
                    <span className={hasLowerCase ? 'text-green-400' : 'text-gray-600'}>
                      Lowercase
                    </span>
                  </div>
                  <div className="flex items-center gap-2">
                    ...
                    <span className={hasNumber ? 'text-green-400' : 'text-gray-600'}>
                      Number
                    </span>
                  </div>
                </div>
          ...
          <div className="flex items-start space-x-3 pt-2">
            <div className="relative">
              ...
              />
              <div className="w-5 h-5 border border-white/20 rounded-md peer-checked:bg-gradient-to-r peer-checked:from-purple-600 peer-checked:to-indigo-600 peer-checked:border-transparent transition-all duration-200 cursor-pointer flex items-center justify-center" onClick={() => {
            ...
            <label htmlFor="terms" className="text-sm text-gray-400 leading-relaxed select-none cursor-pointer">
              I agree to the{' '}
